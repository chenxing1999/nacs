...
def get_args(argv=None):
    ...
    parser.add_argument(
        ...
        choices=['resnet20', 'resnet18', 'resnet50', "deepfm", "dcnv2", "dcn_mix", "fmlp"],
    ...
    parser.add_argument('--dataset', default='cifar10', choices=['cifar10', 'cifar100','tinyimagenet',
                                                                 "criteo", "avazu", "criteo_cl", "avazu_cl"],
    ...
    parser.add_argument("--infer_batch_size", default=None, type=int,
    ...
    parser.add_argument("--selection_method", default="crest", choices=['none', 'random', 'crest', "crest_ctr"],
